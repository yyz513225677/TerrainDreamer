"""CNN encoder for the LiDAR BEV tensor.

Input  : [B, 4, 128, 128]   channels = (occupancy, max_height, elevation, roughness)
Output : [B, terrain_embed]
"""
...
class TerrainEncoder(nn.Module):
    def __init__(self, in_channels: int = 4, embed_dim: int = 512):
        super().__init__()
        # 128 -> 64 -> 32 -> 16 -> 8 with stride-2 convs
