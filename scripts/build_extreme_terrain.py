"""Generate an EXTREME 100 m × 100 m lunar heightmap PNG.

Harder than rugged: 1 m spawn clearance, 8 craters with steeper rims,
deeper river bed, 120 large boulders. Designed as the paper's most
...
Output:
  - data/heightmaps/extreme_heightmap.png   (16-bit grayscale)
  - data/heightmaps/extreme_color.png       (turbo height-based RGB)
...
SIZE_PX = 513
EXTENT_M = 100.0
CENTER_CLEAR_M = 3.0          # spawn clearance — extreme (user requested 3 m)
...
# Impact craters — deeper, steeper rims, more
NUM_CRATERS = 8
CRATER_RADIUS_M = (2.5, 18.0)
CRATER_DEPTH_FRAC = (0.30, 0.50)
CRATER_RIM_FRAC = (0.12, 0.22)

# Eroded river — deeper trench
RIVER_LENGTH_SEG = 80
RIVER_STEP_PX = 12
RIVER_WIDTH_PX = 12
RIVER_DEPTH_FRAC = 0.35
RIVER_SOFT_BANK = 0.18

# Boulders — more, larger
NUM_BOULDERS = 120
BOULDER_RADIUS_PX = (3, 12)
BOULDER_HEIGHT_FRAC = (0.20, 0.60)
...
def main():
    ...
    grey_path = out_dir / "extreme_heightmap.png"
    color_path = out_dir / "extreme_color.png"
    ...
    mask_path = out_dir / "extreme_obstacle_mask.png"
